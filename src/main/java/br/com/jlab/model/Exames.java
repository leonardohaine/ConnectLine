...
public class Exames implements Serializable {
    ...
    public Exames(String exame) {
        this.exame = exame;
    }

    public Exames(String exame, String coletaseparado) {
        this.exame = exame;
    ...
    public Recipientes getRecipiente() {
        return recipiente;
    }

    public void setRecipiente(Recipientes recipiente) {
